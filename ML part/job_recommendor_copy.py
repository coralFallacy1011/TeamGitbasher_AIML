...
job_skill_weights = {  
    "Data Scientist": {"Python": 3, "Machine Learning": 2, "Statistics": 2, "Data Visualization": 1},  
    "Full Stack Developer": {"Java": 3, "JavaScript": 3, "React": 2, "HTML": 1, "CSS": 1},  
    "Data Analyst": {"Excel": 3, "SQL": 2, "Data Mining": 1, "Statistics": 1},  
    "Machine Learning Engineer": {"Python": 3, "TensorFlow": 2, "Machine Learning": 2, "Deep Learning": 1}  
}  
...
# Add weighted skills to DataFrame  
jd_df['Weighted Skills'] = jd_df['Title'].apply(get_weighted_skills)  

# Vectorizing skills (including weighted skills)  
vectorizer = TfidfVectorizer(min_df=1, analyzer=ngrams, lowercase=False)  
tfidf = vectorizer.fit_transform(skills + list(jd_df['Weighted Skills'].values.astype('U')) + list(jd_df['skills'].values.astype('U')))  
