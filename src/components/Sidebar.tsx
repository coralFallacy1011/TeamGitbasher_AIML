...
import logo from 'D:/Akshat/RVCE/Extracurriculars/Gitbashers/jmss/jmss/src/resources/5941749.png'; // Example logo import (adjust path as needed)
  ...
  return (
    <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <div className="logo">
        ...
        {!isCollapsed && <span className="logo-text">Jobmiljayesimsim</span>}
      </div>
      <ul>
